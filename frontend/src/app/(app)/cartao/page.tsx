              ...
              <div style={{ display: 'flex', gap: 10, justifyContent: 'flex-end' }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: 8,
                    border: 'none',
                    background: deleteLoading ? 'var(--surface-panel)' : 'rgba(229,62,62,0.85)',
                    color: deleteLoading ? 'var(--text-muted)' : '#fff',
                    fontSize: 13,
                    fontWeight: 600,
                    cursor: (deleteLoading || deleteTarget.loadingInfo) ? 'not-allowed' : 'pointer',
                    opacity: (deleteLoading || deleteTarget.loadingInfo) ? 0.75 : 1,
                  }}
                >
                ...
                <div key={card.id}>
                  <div style={{
                    ...
                    <div style={{
                      ...
                      <Link
                        href={`/upload?type=credit_card&cardId=${card.id}`}
