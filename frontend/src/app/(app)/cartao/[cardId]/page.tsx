...
export default function CardDetailPage({ params }: PageProps) {
  ...
  return (
    <>
      <Header title={card.name} subtitle="Configuração e faturas importadas" />
      <main style={{ padding: 24, flex: 1 }}>
        <div style={{
          ...
          <div>
            <div style={{ color: 'var(--text-secondary)', fontSize: 13, marginBottom: 6 }}>
              Instituição: {card.institution || 'Não informada'}
            </div>
        ...
        {invoices.length === 0 ? (
          <EmptyState
            ...
            message="Importe uma fatura para visualizar os lançamentos."
